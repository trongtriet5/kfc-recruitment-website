      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formInfo?.fields && formInfo.fields.length > 0 && (
              <div className="border-b border-gray-200 pb-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Thông tin bổ sung</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {formInfo.fields.map((field: any) => (
                    <div key={field.id} className={field.width === '100%' ? 'col-span-full' : ''}>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      {field.helpText && (
                        <p className="mt-1 text-xs text-gray-500 italic">{field.helpText}</p>
                      )}
                    </div>
                  ))}
                </div>
